...
# Some people consider them to be the most influential act of the rock era. Indeed, they were included in Time magazine's compilation of 
...
# step 3
for i in range(2):
    members = input("Add the following member: ")
